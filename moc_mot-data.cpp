...
void motHandler::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<motHandler *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        {
            using _t = void (motHandler::*)(QByteArray , int );
...
QT_INIT_METAOBJECT const QMetaObject motHandler::staticMetaObject = { {
    ...
    qt_meta_stringdata_motHandler.data,
    qt_meta_data_motHandler,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *motHandler::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, "virtual_dataHandler"))
        return static_cast< virtual_dataHandler*>(this);
