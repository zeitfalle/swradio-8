...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_drmDecoder_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_drmDecoder_t qt_meta_stringdata_drmDecoder = {
    {
QT_MOC_LITERAL(0, 0, 10), // "drmDecoder"
QT_MOC_LITERAL(1, 11, 14), // "audioAvailable"
QT_MOC_LITERAL(2, 26, 0), // ""
QT_MOC_LITERAL(3, 27, 17), // "setDetectorMarker"
QT_MOC_LITERAL(4, 45, 15), // "adjustFrequency"
QT_MOC_LITERAL(5, 61, 17), // "show_stationLabel"
QT_MOC_LITERAL(6, 79, 14), // "show_timeLabel"
QT_MOC_LITERAL(7, 94, 6), // "showIQ"
...
void drmDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<drmDecoder *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
        ...
        case 3: _t->show_stationLabel((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< int(*)>(_a[2]))); break;
        case 4: _t->show_timeLabel((*reinterpret_cast< const QString(*)>(_a[1]))); break;
        case 5: _t->showIQ((*reinterpret_cast< int(*)>(_a[1]))); break;
        ...
        {
            using _t = void (drmDecoder::*)(int , int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&drmDecoder::audioAvailable)) {
                *result = 0;
                return;
            }
        }
        {
            using _t = void (drmDecoder::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&drmDecoder::setDetectorMarker)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (drmDecoder::*)(int );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&drmDecoder::adjustFrequency)) {
                *result = 2;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject drmDecoder::staticMetaObject = { {
    QMetaObject::SuperData::link<virtualDecoder::staticMetaObject>(),
    qt_meta_stringdata_drmDecoder.data,
    qt_meta_data_drmDecoder,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *drmDecoder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_drmDecoder.stringdata0))
...
// SIGNAL 0
void drmDecoder::audioAvailable(int _t1, int _t2)
{
...
// SIGNAL 1
void drmDecoder::setDetectorMarker(int _t1)
{
...
// SIGNAL 2
void drmDecoder::adjustFrequency(int _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
