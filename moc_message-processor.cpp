...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_messageProcessor_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_messageProcessor_t qt_meta_stringdata_messageProcessor = {
    {
QT_MOC_LITERAL(0, 0, 16), // "messageProcessor"
QT_MOC_LITERAL(1, 17, 11), // "sendMessage"
QT_MOC_LITERAL(2, 29, 0) // ""

    },
    "messageProcessor\0sendMessage\0"
};
...
void messageProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            using _t = void (messageProcessor::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&messageProcessor::sendMessage)) {
                *result = 0;
                return;
            }
        }
...
QT_INIT_METAOBJECT const QMetaObject messageProcessor::staticMetaObject = { {
    QMetaObject::SuperData::link<QObject::staticMetaObject>(),
    qt_meta_stringdata_messageProcessor.data,
