...
struct qt_meta_stringdata_ssbDecoder_t {
    QByteArrayData data[6];
    char stringdata0[81];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ssbDecoder_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ssbDecoder_t qt_meta_stringdata_ssbDecoder = {
    {
QT_MOC_LITERAL(0, 0, 10), // "ssbDecoder"
QT_MOC_LITERAL(1, 11, 18), // "set_adaptiveFilter"
QT_MOC_LITERAL(2, 30, 0), // ""
QT_MOC_LITERAL(3, 31, 22), // "set_adaptiveFiltersize"
QT_MOC_LITERAL(4, 54, 17), // "set_lowpassFilter"
QT_MOC_LITERAL(5, 72, 8) // "set_mode"

    },
    "ssbDecoder\0set_adaptiveFilter\0\0"
    "set_adaptiveFiltersize\0set_lowpassFilter\0"
    "set_mode"
};
...
void ssbDecoder::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<ssbDecoder *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject ssbDecoder::staticMetaObject = { {
    QMetaObject::SuperData::link<virtualDecoder::staticMetaObject>(),
    qt_meta_stringdata_ssbDecoder.data,
    qt_meta_data_ssbDecoder,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *ssbDecoder::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ssbDecoder.stringdata0))
        return static_cast<void*>(this);
    if (!strcmp(_clname, "Ui_ssb_decoder"))
        return static_cast< Ui_ssb_decoder*>(this);
