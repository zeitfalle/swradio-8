...
QT_MOC_LITERAL(1, 14, 14), // "show_audioMode"
QT_MOC_LITERAL(2, 29, 0), // ""
QT_MOC_LITERAL(3, 30, 9), // "putSample"
QT_MOC_LITERAL(4, 40, 11), // "faadSuccess"
QT_MOC_LITERAL(5, 52, 15) // "show_datacoding"

    },
    "dataProcessor\0show_audioMode\0\0putSample\0"
    "faadSuccess\0show_datacoding"
};
...
void dataProcessor::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->show_datacoding((*reinterpret_cast< QString(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dataProcessor::show_audioMode)) {
                *result = 0;
                return;
            }
        }
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dataProcessor::putSample)) {
                *result = 1;
                return;
            }
        }
        {
            using _t = void (dataProcessor::*)(bool );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dataProcessor::faadSuccess)) {
                *result = 2;
                return;
            }
        }
        {
            using _t = void (dataProcessor::*)(QString );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&dataProcessor::show_datacoding)) {
                *result = 3;
                return;
            }
        }
...
// SIGNAL 3
void dataProcessor::show_datacoding(QString _t1)
{
    void *_a[] = { nullptr, const_cast<void*>(reinterpret_cast<const void*>(std::addressof(_t1))) };
